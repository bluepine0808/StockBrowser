...
import com.android.stockbrowser.provider.BrowserProvider2;
import com.android.stockbrowser.view.BookmarkExpandableView;
import com.android.stockbrowser.view.BookmarkExpandableView.BookmarkContextMenuInfo;
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        if (loader.getId() == LOADER_ACCOUNTS) {
            ...
            if (id == LOADER_BOOKMARKS){ // Didn't find any bookmarks
                Bundle args = new Bundle();
                args.putString(ACCOUNT_NAME, "");
                args.putString(ACCOUNT_TYPE, "");
                BrowserBookmarksAdapter adapter = new BrowserBookmarksAdapter(
                        getActivity());
                mBookmarkAdapters.put(id, adapter);
                boolean expand = true;
